          ...
          <Cell col={8}>
            <center>  <h3>ABOUT ME</h3> </center>
             <hr />
              ...
              <p className="about-text"> Full Stack Developer using MySQL, MongoDB, ReactJS, VueJS with an emphasis on Frontend web development.
                  Experienced in building CRUD applications, RESTful APIs using Laravel, User Auth and oAuth with PassportJS and Firebase.
                  Common libraries of use: Axios, Redux, Mongoose, Lodash, Express, body-parser, socket.io, react-router, redux- thunk.
                  Common use of UI libraries: Bootstrap 4, React-Bootstrap, MaterializeCSS, Material-UI, Elemental-UI. </p>
          </Cell>
          <Cell col={2}></Cell>
        </Grid>
      </div>
